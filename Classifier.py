...
def get_data(csv_path):
    ...
    data = csv_data.values.astype(np.float)[:, 0:128]
    label = csv_data.values.astype(np.int)[:, 128:]
...
if __name__ == '__main__':
    ...
    train_data, test_data, train_label, test_label = get_data('G:\\share\\training_data\\func.csv')
